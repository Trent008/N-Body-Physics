...
class Planet:
    ...
    def getRelativeAcceleration(self, other):
        difference = other.position.getSubtracted(self.position) # find the distance vector to the other planet
        ...
        return difference.getScaled(other.mass / pow(rSquared, 1.5))
